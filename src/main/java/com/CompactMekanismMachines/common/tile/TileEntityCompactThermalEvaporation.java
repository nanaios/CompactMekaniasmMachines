...
public class TileEntityCompactThermalEvaporation extends TileEntityConfigurableMachine implements ISingleRecipeLookupHandler.FluidRecipeLookupHandler<FluidToFluidRecipe> {
    ...
    public boolean onUpdateServer(){
        ...
        tempMultiplier = (Math.min(MAX_MULTIPLIER_TEMP, getTemperature()) - HeatAPI.AMBIENT_TEMP) * MekanismConfig.general.evaporationTempMultiplier.get()*((double) CompactMekanismMachinesConfig.storage.evaporationHeight.get()/18);
