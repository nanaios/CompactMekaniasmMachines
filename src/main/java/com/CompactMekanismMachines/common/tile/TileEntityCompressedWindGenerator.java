...
public abstract class TileEntityCompressedWindGenerator<TILE extends TileEntityCompressedWindGenerator<TILE>>  extends TileEntityGenerator implements IBoundingBlock{
    ...
    public TileEntityCompressedWindGenerator(Holder<Block> blockProvider, BlockPos pos, BlockState state, long multiplier) {
        super(blockProvider, pos, state, () -> MekanismGeneratorsConfig.generators.windGenerationMax.get() * multiplier);
